...
# or for Amazon Bedrock
gemba --source=source.txt --hypothesis=hypothesis.txt --source_lang=English --target_lang=Czech --method="GEMBA-MQM" --model="anthropic.claude-3-sonnet-20240229-v1:0"
```
